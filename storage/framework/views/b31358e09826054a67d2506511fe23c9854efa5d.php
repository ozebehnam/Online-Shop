  ...
  <div class="block-standart block-product-view">
   <div class="product-content">
     <div class="product-images">
       <a href="<?php echo e(asset($Product->img)); ?>" class="jqzoom" rel="product" target="_blank"><img src="<?php echo e(asset($Product->img)); ?>"></a>
         ...
         <div class="product-rating"><img src="<?= asset('site/images/rating-3.png'); ?>"></div>
               ...
               <!-- <div class="product-row product-info">
                 ...
                 <div class="product-row product-cart">
                   ...
                   <div class="product-price"><span class="product-price-last"><?php echo e(number_format($Product->price)); ?> تومان</span> <span class="product-price-new"><?php echo e(number_format($Product->price)); ?> تومان</span></div>
                   <div class="product-cart-controls">
                    ...
                    <a class="button icon-cart" onclick="add_product(<?php echo e($Product->id); ?>)">افزودن به سبد خرید</a>
                  </div>
                </div>
                <div class="product-row">
...
<!-- <?php echo Html::script('js/jquery3.js'); ?> -->
